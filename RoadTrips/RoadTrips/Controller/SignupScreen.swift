...
class SignupScreen: UIViewController{
    ...
    let nameTextField: UITextField = {
       let textField = UITextField()
        ...
        textField.setupTF(with: NSAttributedString(string: NSLocalizedString("Name", comment: ""), attributes: [NSAttributedString.Key.foregroundColor:UIColor.white]))
      return textField
    }()
    ...
    private func setupViews() {
        ...
        emailTextField.addSubview(emailTextField)
